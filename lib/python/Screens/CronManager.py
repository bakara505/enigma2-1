# Embedded file name: /usr/lib/enigma2/python/Screens/CronManager.py
from . import _
...
config.plugins.aafpanel.cronmanager_runwhen = NoSave(ConfigSelection(default='Daily', choices=[('Hourly', _('Hourly')),
 ('Daily', _('Daily')),
 ('Weekly', _('Weekly')),
 ('Monthly', _('Monthly'))]))
config.plugins.aafpanel.cronmanager_dayofweek = NoSave(ConfigSelection(default='Monday', choices=[('Monday', _('Monday')),
 ('Tuesday', _('Tuesday')),
...
class CronManager(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions'], {'ok': self.info,
         'back': self.close,
         'red': self.addtocron,
         'green': self.delcron,
...
class SetupCronConf(Screen, ConfigListScreen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions', 'VirtualKeyboardActions'], {'red': self.checkentry,
         'back': self.close,
